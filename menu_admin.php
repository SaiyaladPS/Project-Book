      ...
      <div class="app-header-content">
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-md-6" style="padding-top: 10px;">
            <h4 class='text-right'>ຍິນດີຕ້ອນຮັບ<?= $_SESSION['fname'] . " " . $_SESSION['lname']; ?></h3>
          </div><!--//col-->
      ...
      <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
          ...
          <div class="app-branding">
            <a class="app-logo" href="#"><img class="logo-icon me-3" src="download (1).jpeg" alt="logo"><span class="logo-text">Nunee BookShop</span></a>
          </div><!--//app-branding-->
              ...
              <li class="nav-item has-submenu">
                ...
                <div id="submenu-5" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                  <ul class="submenu-list list-unstyled">
                    ...
                    <li class="submenu-item"><a class="submenu-link" href="receives3/select-receives.php" target="n">ຊອກຫາສິນຄ້ານຳເຂົ້າ</a></li>
                  </ul>
                </div>
              </li><!--//nav-item-->
              <li class="nav-item has-submenu">
                ...
                <div id="submenu-3" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                  <ul class="submenu-list list-unstyled">
                    <!-- ໂຟລເດີ orders -->
                    <li class="submenu-item"><a class="submenu-link" href="orders/select_orders.php" target="n">ບັນທຶກຂໍ້ມູນສິນຄ້າຂາຍອອກ</a></li>
                    <li class="submenu-item"><a class="submenu-link" href="orders4/select-orders.php" target="n">ລາຍຂໍ້ມູນສິນຄ້າຂາຍອອກ</a></li>
                    <li class="submenu-item"><a class="submenu-link" href="orders4/select-orders.php" target="n">ຊອກຫາສິນຄ້າຂາຍ</a></li>
                  </ul>
                </div>
              </li><!--//nav-item-->
              ...
              <ul class="app-menu footer-menu list-unstyled">
                <li class="nav-item has-submenu">
                  <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-4" aria-expanded="false" aria-controls="submenu-2">
                    ...
                    <span class="nav-link-text"><b>ຜູ້ນຳໃຊ້</b></span>
                    <span class="submenu-arrow">
                      <i class="fas fa-angle-down right"></i>
                    </span><!--//submenu-arrow-->
                  </a><!--//nav-link-->
                  <div id="submenu-4" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                      <li class="submenu-item"><a class="submenu-link" href="user8/form_user.php" target="n">ລົງທະບຽນຜູ້ນຳໃຊ້</a></li>
                      <li class="submenu-item"><a class="submenu-link" href="user8/select-user.php" target="n">ຂໍ້ມູນຜູ້ລົງທະບຽນ</a></li>
                    </ul>
                  </div>
                </li>
                <li class="nav-item has-submenu">
                  <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#pdv" aria-expanded="false" aria-controls="submenu-1">
                    <span class="nav-icon">
                      <i class="ti ti-building-skyscraper" style="font-size: 20px;"></i>
                    </span>
                    <span class="nav-link-text"><b>ບັນທຶກແຂວງ, ເມືອງ, ບ້ານ</b></span>
                    <span class="submenu-arrow">
                      <i class="fas fa-angle-down right"></i>
                    </span><!--//submenu-arrow-->
                  </a><!--//nav-link-->
                  <div id="pdv" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                      <li class="submenu-item"><a class="submenu-link" href="provinces5/form_provinces.php" target="n">ແຂວງ</a></li>
                      <li class="submenu-item"><a class="submenu-link" href="districts6/form_districts.php" target="n">ເມືອງ</a></li>
                      <li class="submenu-item"><a class="submenu-link" href="villages7/form_villages.php" target="n">ບ້ານ</a></li>
                    </ul>
                  </div>
                </li><!--//nav-item-->
              </ul><!--//footer-menu-->
